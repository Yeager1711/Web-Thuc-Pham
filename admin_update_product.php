...
if (isset($_POST['update_product'])) {
    ...
    array_push($success_msgs, 'Cập nhật sản phẩm thành công ');
    ...
    if (!empty($image)) {
        if ($image_size > 2000000) {
            ...
            if ($update_image) {
                move_uploaded_file($image_folder, $image_tmp_name);
                unlink('uploaded_img/' . $old_image);
                array_push($success_msgs, 'Cập nhật ảnh thành công');
            }
        }
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="./css//admin_update-products.css">
</head>
